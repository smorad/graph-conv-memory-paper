...
class PPAE(ObservationTransformer):
    def __init__(self, env, cpt_path="/root/vnav/ae.pt"):
        super().__init__()
    ...
    def transform_observation_space(self, obs_space):
        ...
        ), "AE requires depth and semantic images"
